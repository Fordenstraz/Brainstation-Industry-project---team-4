...
const actions = [
  ...
  { icon: <img src={nytGames} alt="Games" style={{ width: 40, height: 40, borderRadius: '50%' }} />, name: 'Games' },
  { icon: <img src={nytAudio} alt="Audio" style={{ width: 40, height: 40, borderRadius: '50%' }} />, name: 'Audio' },
  { icon: <img src={nytAthletic} alt="Athletic" style={{ width: 40, height: 40, borderRadius: '50%' }} />, name: 'Athletic' },
  { icon: <img src={nytWirecutter} alt="Wirecutter" style={{ width: 40, height: 40, borderRadius: '50%' }} />, name: 'Wirecutter' },
];
...
export default function SpeedDialNav() {
  ...
  return (
    <>
      ...
      >
        <DialogTitle>{currentContent.charAt(0).toUpperCase() + currentContent.slice(1)}</DialogTitle>
        <DialogContent>
          {/* Cooking Modal */}
              ...
              <Card sx={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center', boxShadow: 'none' }}>
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ marginBottom: 2 }}>
                    Discover the deliciousness of our smash burgers, featuring a crispy exterior and juicy interior.
            ...
            <>
              ...
              <Grid container spacing={2} justifyContent="center">
                ...
                <Grid item xs={12} sm={6} md={6}>
                  <Card sx={{ backgroundColor: '#F7DA21', textAlign: 'center' }}>
                    <CardMedia
                      component="img"
                      image={spellingBeeLogo}
                      alt="Spelling Bee"
                      sx={{ width: 60, height: 60, margin: '20px auto' }}
                    />
                    <Typography variant="h6" sx={{ fontWeight: 'bold' }}>
                      Spelling Bee
                    </Typography>
                ...
                {/* Wordle */}
                <Grid item xs={12} sm={6} md={6}>
                  <Card sx={{ backgroundColor: '#E3E3E1', textAlign: 'center' }}>
                    <CardMedia
                      component="img"
                      image={wordlelogo}
                      alt="Wordle"
              ...
              <Button
                variant="outlined"
                sx={{ marginTop: 3, display: 'block', marginLeft: 'auto', marginRight: 'auto', borderRadius: '22px' }}
                onClick={() => window.open('https://www.nytimes.com/crosswords', '_blank')}
              >
            ...
            <>
              ...
              <Card sx={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center', boxShadow: 'none' }}>
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ marginBottom: 2 }}>
                    Discover the best products as reviewed by our experts. Stay informed with the latest trends and reviews.
                  </Typography>
                  <CardMedia
                    component="img"
                  ...
                  <Button
                    ...
                    onClick={() => window.open('https://www.nytimes.com/wirecutter', '_blank')}
                  >
            ...
            <>
              ...
              <Grid container spacing={2} alignItems="center" justifyContent="center">
                <Grid item xs={12} sm={6}>
                  <Typography variant="h7" sx={{ fontWeight: 'bold', marginBottom: 2 }}>
                    Man City dominates Ipswich in a thrilling 3-1 victory at the Etihad Stadium. A masterclass performance by Kevin De Bruyne and Raheem Sterling, who both played pivotal roles in securing the win.
                  </Typography>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <CardMedia
              ...
              <Box textAlign="center" sx={{ marginTop: 3 }}>
                ...
                <Typography variant="h6" sx={{ marginTop: 1 }}>
                  <img src={manCityLogo} alt="Man City" style={{ width: '40px', verticalAlign: 'middle', marginRight: '10px' }} />
                  3 - 1
                  <img src={ipswichLogo} alt="Ipswich" style={{ width: '40px', verticalAlign: 'middle', marginLeft: '10px' }} />
                </Typography>
                <Typography variant="h6" sx={{ marginTop: 1 }}>
                  FT
                </Typography>
